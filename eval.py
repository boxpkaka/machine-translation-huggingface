...
def _eval_with_metric(args):
    ...
    model = load_from_checkpoint('/workspace/volume/data3-lianxiang/300-MT-Pro/model/comet/checkpoints/model.ckpt')
    tokenizer = XLMRobertaTokenizerFast.from_pretrained('/workspace/volume/data3-lianxiang/300-MT-Pro/model/xlm-roberta-large')
